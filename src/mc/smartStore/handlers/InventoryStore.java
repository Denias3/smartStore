...
//                stores.updateStore(p);
                ...
                if (stores.getStatus() == StatusStore.PRICE){
...
//                    }
                ...
                else if (stores.getStatus() == StatusStore.SAVE){
//                    p.closeInventory();
//                    p.sendMessage(
//                    "§7------------------------------------\n"+
...
//            if (slot >= size - 9 | stores.getStatus() != StatusStore.MOVE) {
//                e.setCancelled(true);
//            }
...
//                    }
                } else if (stores.getStatus() == StatusStore.PRICE) {
//                    p.closeInventory();
//                    stores.updateStats(p, slot);
                }
                else {
